...
public class addGameT extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(!isEmpty(cat)&& !isEmpty(type)&&!isEmpty(name)&&!isEmpty(desc)){
            

            if(type.equals("TF")){
                addQuestionsT tt = new addQuestionsT();
                tt.setVars(uname , upass,type, name, cat, desc);
                this.dispose();
                
            }else{
                addQuestionsMCQ tt = new addQuestionsMCQ();
                tt.setVars(uname , upass ,type, name, cat, desc);    
                this.dispose();
            }
        }else{
